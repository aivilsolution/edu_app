...
class _RoomPageState extends State<RoomPage> {
  ...
  void _setupInitialMediaState() async {
    try {
      if (widget.videoCall) {
      ...
      print('Error setting up initial media state: $error');
    }
  }
  ...
  void _sortParticipants() {
    ...
    if (localParticipantTracks != null) {
      ...
      if (!widget.videoCall &&
          !localParticipantTracks.any((t) => t.isScreenShare)) {
        userMediaTracks.add(
          ParticipantTrack(participant: widget.room.localParticipant!),
        );
      }
