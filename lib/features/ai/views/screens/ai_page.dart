...
class AuthProvider extends StatelessWidget {
      ...
      builder: (context, authState) {
        switch (authState.status) {
          ...
          case AuthStatus.authenticated:
            return _buildMediaRepositoryProvider(context, authState.user!);
          case AuthStatus.unauthenticated:
            return _buildAuthenticationScreen();
          case AuthStatus.error:
            return _buildErrorWidget(
              authState.errorMessage ?? 'Unknown authentication error',
            );
        }
      },
    );
  ...
  Widget _buildMediaRepositoryProvider(BuildContext context, AppUser user) {
...
class _ChatBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ChatCubit, ChatState>(
      listenWhen: (_, current) => current is ChatErrorState,
      listener: (context, state) {
